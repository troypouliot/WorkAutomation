...
layout = [  [sg.Text('This tool lists models that have CAD data.\nFor models in the current directory, this mean the "[part_no]" folder has been '
                     'renamed to the model number.\nFor older models, this mean there is IGI CAD data available.')],
            [sg.Text('Model prefix to search for:'), sg.Input(key='-prefix-', size=(6), enable_events=True),
            ...
            [sg.Multiline(size=(90,20), key='-MLINE_KEY-', write_only=True, auto_refresh=True, autoscroll=True, disabled=True)],
            ...
            [sg.Push(), sg.Text('Ver:{}'.format(version), font='Any 6', pad=0)]]
